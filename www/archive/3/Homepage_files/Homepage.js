IMpreload('Homepage_files', 'shapeimage_11', '0');
var MINIMUM_FONT = "10";
var UNITS = "";
...
function onPageLoad()
{
    ...
    fixupIEPNG("id1", "Homepage_files/transparent.gif");
    fixupAllIEPNGBGs();
    fixupIEPNG("id3", "Homepage_files/transparent.gif");
    fixupIEPNG("id4", "Homepage_files/transparent.gif");
    fixupIEPNG("id6", "Homepage_files/transparent.gif");
    fixupIEPNG("id7", "Homepage_files/transparent.gif");
    fixupIEPNG("id8", "Homepage_files/transparent.gif");
    fixupIEPNG("id15", "Homepage_files/transparent.gif");
    fixupIEPNG("id16", "Homepage_files/transparent.gif");
    fixupIEPNG("id20", "Homepage_files/transparent.gif");
    fixupIEPNG("id23", "Homepage_files/transparent.gif");
    fixupIEPNG("id28", "Homepage_files/transparent.gif");
    fixupIEPNG("shapeimage_11_link_0", "Homepage_files/transparent.gif");
    fixupIEPNG("shapeimage_11", "Homepage_files/transparent.gif");
    fixupIEPNG("id32", "Homepage_files/transparent.gif");
    return true;
}

...
function onPageLoad()
{
    ...
    fixupIEPNG("id10", "About_files/transparent.gif");
    fixupIEPNG("id11", "About_files/transparent.gif");
    fixupIEPNG("id12", "About_files/transparent.gif");
    fixupIEPNG("id13", "About_files/transparent.gif");
    fixupIEPNG("id14", "About_files/transparent.gif");
    fixupIEPNG("id15", "About_files/transparent.gif");
    fixupIEPNG("id19", "About_files/transparent.gif");
    fixupIEPNG("id20", "About_files/transparent.gif");
    return true;
}
